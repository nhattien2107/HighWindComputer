...
public class editbillServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            bill bi=biDAO.findByBillID(id);
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd"); 
            bi.setBill_date(sdf.parse(request.getParameter("bill_date"))); 
            bi.setManager_id(Integer.parseInt(request.getParameter("manager_id"))); out.print("aaaa");
            bi.setCustomer_id(Integer.parseInt(request.getParameter("customer_id")));
            bi.setStatus(request.getParameter("status"));
