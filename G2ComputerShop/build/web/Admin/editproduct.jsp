...
<html>
    ...
    <body>
        ...
        <section id="main-content">
            ...
            <form action="../editproductServlet" method="post" enctype="multipart/form-data" name="myform" onsubmit="return validateForm()">
                <% 
            ...
            <table style="width: 700px;">
                ...
                <tr>
                    ...
                    <td style='padding-left: 14px;'>
                        <textarea name="product_detail" rows="10" cols="50" style="border-bottom: 2px solid #5fbae9;">
                ...
                <tr>
                    <td>Product Date </td>
                    <td style="padding-left: 14px;">
                        <input type="date" name="product_date" value='<%out.print(rs.getProduct_date());%>'/>
                ...
                <tr>
                    ...
                    <td style="padding-left: 14px;">
                        <input type="number" name="purchase_price" value='<%out.print(rs.getPurchase_price());%>'/>
                 ...
                 <tr>
                    <td>Price </td>
                    <td style="padding-left: 14px;">
                        <input type="number" name="price" value='<%out.print(rs.getPrice());%>'/>
                ...
                <tr>
                    <td>Discount </td>
                    <td style="padding-left: 14px;">
                        <input type="number" name="discount" value='<%out.print(rs.getDiscount());%>'/>
                ...
                <tr>
                    <td>Stock </td>
                    <td style="padding-left: 14px;">
                        <input type="number" name="stock" value='<%out.print(rs.getStock());%>'/>
                ...
                <tr>
                    <td>Unit Sold </td>
                    <td style="padding-left: 14px;">
                        <input type="number" name="unit_sold" value='<%out.print(rs.getUnit_sold());%>'/>
                ...
                <tr>
                    <td>Warrant </td>
                    <td style="padding-left: 14px;">
                        <input type="number" name="warrant" value='<%out.print(rs.getWarrant());%>'/>
                ...
                <tr>
                    <td>Images</td>
                    <td style="padding-left: 14px;"><img src='../images/product/<%out.print(rs.getImages());%>' width="100px"/> <br/>
