...
<html>
    ...
    <body>
        ...
        <section id="main-content">
            ...
            <form action="../editmanagerServlet" method="post" enctype="multipart/form-data" name="myform" onsubmit="return validateForm()">
                <% 
            ...
            <table style="width: 700px;">
                ...
                <tr>
                    ...
                    <td style="padding-left: 14px;">
                        <input type="date" name="dOB" value='<%out.print(rs.getdOB());%>'>
                ...
                <tr>
                    <td>Email </td>
                    <td>
                        <input type="text" name="email" value='<%out.print(rs.getEmail());%>'/>
                ...
                <tr>
                    <td>Phone </td>
                    <td>
                        <input type="text" name="phone" value='<%out.print(rs.getPhone());%>'/>
                ...
                <tr>
                    <td>Salary </td>
                    <td style="padding-left: 14px;">
                        <input type="number" name="salary" value='<%out.print(rs.getSalary());%>'>
                ...
                <tr>
                    <td>Position </td>
                    <td>
                        <input type="text" name="position" value='<%out.print(rs.getPosition());%>'/>
                 ...
                 <tr>
                    <td>Username </td>
                    <td>
                        <input type="text" name="username" value='<%out.print(rs.getUsername());%>'/>
                ...
                <tr>
                    <td>Password </td>
                    <td>
                        <input type="text" name="pass" value='<%out.print(rs.getPass());%>'/>
