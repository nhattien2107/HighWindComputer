    ...
    <body>
        ...
        <header class="header">
            ...
            <div class="main__content">
                ...
                <%
                    String typeid = request.getParameter("producttype_id");
                    producttypeDAO typeDAO = new producttypeDAO();
                    producttype rs = typeDAO.findByID(typeid);
                %>
                <div class="product__name">
                    <span><%out.print(rs.getProducttype_name());%></span>
                </div>
            </div>
                ...
                <div class="all__products">
                    <div class="product__title">
                        <div class="title__text">
                            <h3><%out.print(rs.getProducttype_name());%> Products</h3>
                        </div>
                    </div>
                    <div class="owl-carousel owl-theme">
                        <%
                            ...
                            list = proDAO.findByTypeID(typeid);
