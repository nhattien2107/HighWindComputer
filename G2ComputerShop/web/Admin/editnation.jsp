...
<html>
    ...
    <body>
        ...
        <section id="main-content">
            ...
            <form action="../editnationServlet" method="post" enctype="multipart/form-data" name="myform" onsubmit="return validateForm()">
                <% 
                String id =request.getParameter("id");
                nationDAO naDAO=new nationDAO();
                nation rs= naDAO.findByID(id);
                %>
            <h3 style="text-align:center;"> Edit Nation</h3>
            <table style="width: 700px;">
                <tr>
                    <td>Nation Name </td>
                    <td>
                        <input type="hidden" name="nation_id" value='<%out.print(rs.getNation_id());%>'/>
                        <input type="text" name="nation_name" value='<%out.print(rs.getNation_name());%>'/>
