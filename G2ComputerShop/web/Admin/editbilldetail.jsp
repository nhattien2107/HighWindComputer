...
<html>
    ...
    <body>
        ...
        <section id="main-content">
            ...
            <form action="../editbilldetailServlet" method="post" enctype="multipart/form-data" name="myform" onsubmit="return validateForm()">
                <% 
            ...
            <table style="width: 700px;">
                ...
                <tr>
                    <td>Amount </td>
                    <td style="padding-left: 14px;"><input type="number" name="amount" value='<%out.print(rs.getAmount());%>'/></td>
                    <p id="error" class="hidden" style="color: red">Please Input Amount !!!<p>
                    <p id="error2" class="hidden" style="color: red">Please Input Valid Amount !!!<p>
                </tr>
                <tr>
